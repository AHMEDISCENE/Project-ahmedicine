  ...
  const filteredGroupedCases = useMemo(() => {
    ...
    Object.entries(groupedCases).forEach(([hospitalKey, tumourGroups]) => {
      ...
      Object.entries(tumourGroups).forEach(([tumourType, cases]) => {
        ...
        const patientMatches = cases.some(
          (case_) =>
            case_.patient_name?.toLowerCase().includes(query) || case_.owner_name?.toLowerCase().includes(query),
        )

        if (hospitalMatches || tumourMatches || patientMatches) {
          ...
          <CardContent>
            ...
            <div className="mb-6">
              <div className="relative">
                ...
                <Input
                  placeholder="Search hospitals, tumour types, or patient names..."
                  value={searchQuery}
                                        ...
                                        <div className="flex items-center justify-between">
                                          <div>
                                            ...
                                            <div className="flex items-center space-x-4 text-sm text-slate-600 dark:text-slate-400 mt-1">
                                              <span className="flex items-center">
                                                ...
                                                {case_.owner_name || "Unknown Owner"}
                                              </span>
                                              <span className="flex items-center">
                                          ...
                                          <div className="flex items-center space-x-2">
                                            ...
                                            <Button
                                              size="sm"
                                              variant="outline"
                                              className="h-8 border-teal-200 dark:border-teal-800 hover:bg-teal-50 dark:hover:bg-teal-900/20 bg-transparent"
